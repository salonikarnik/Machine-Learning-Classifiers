...
d <- na.omit(d)
names(d) <- c("ID number","Outcome","Time","radius","texture","perimeter","area","smoothness","compactness","concavity","concave points","symmetry","fractal dimension","radius SE","texture SE","perimeter SE","area SE","smoothness SE","compactness SE","concavity SE","concave points SE","symmetry SE","fractal dimension SE","Worst radius","Worst texture","Worst perimeter","Worst area","Worst smoothness","Worst compactness","Worst concavity","Worst concave points","Worst symmetry","Worst fractal dimension")
...
for(i in 1:10) {
  ...
  conf <- confusionMatrix(pred, testData[,1])
  ...
  predTable <- table(predicted = RFpred,observed = testData[Class])
